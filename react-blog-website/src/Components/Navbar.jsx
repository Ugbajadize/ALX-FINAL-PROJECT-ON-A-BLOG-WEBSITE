...
const Navbar = () => {
  ...
  return (
    <header className='bg-black text-white fixed top-0 left-0 right-0'>
        <nav className='px-4 py-4 max-w7xl mx-auto flex justify-between items-center'>
            <a href="/" className='text-xl font-bold text-white'>Hear<span className='text-orange-500'>InFo</span></a>
