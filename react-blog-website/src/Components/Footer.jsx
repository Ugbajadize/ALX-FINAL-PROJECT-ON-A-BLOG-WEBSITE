    ...
    <div className='bg-gray-900'>
        <div className='px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-4'>
            <div className='grid mb-8 lg:grid-cols-6'>
                    ...
                    <div>
                     ...
                     <p className='font-medium tracking-wide text-gray-300'>Apples</p>
                        <ul className='mt-2 space-y-2'>
                            ...
                            <li>
                                <a href="/" className='text-gray-500 transition-colors duration-300 
                                hover:text-orange-500'>Bussiness</a>
                            </li>
                            <li>
                                <a href="/" className='text-gray-500 transition-colors duration-300 
                     ...
                     <div>
                     <p className='font-medium tracking-wide text-gray-300'>Bussiness</p>
                        <ul className='mt-2 space-y-2'>
                            <li>
                                <a href="/" className='text-gray-500 transition-colors duration-300 
                ...
                <p className='mt-4 text-sm text-gray-500'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Culpa ratione consequatur
                adipisci deserunt facilis expedita aliquam exercitationem excepturi iusto repudiandae incidunt
                nihil, illum in natus reprehenderit deleniti architecto veritatis odit.</p>
              </div>
            </div>
